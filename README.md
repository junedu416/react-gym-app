...
**Feature suggestions:** 
Check-in/checkout button to track visitor flows
...
**Feature suggestions:** 
Admins create/view/update/delete gym event and group classes
Set Class Capacity
...
**Feature Suggestions:** 
View personal trainer information/availability;
Book/cancel PT session
...
**Feature Suggestions:** 
Team page;
Personal session booking platform
...
**Revision**: Vivian is an outgoing university student. She enjoys meeting new people and loves group exercise classes/events. She travels a lot, so she often needs to freeze/renew her gym membership plan based on her travel itinerary. It has been a headache for her to constantly call the gym staff and get them to check/change her membership status.

**Feature Suggestions:** 
* Book/cancel group events/classes
* A calender where users can view/update upcoming classes
* Membership settings
...
**Feature Suggestions:**
Report unsocial customer's behaviour;
...
Auto workout mode (auto increment/decrement weights/distance based on what exercise users are doing)
...
**Feature Suggestions:** 
Create/view/update/delete customised workout routine;
____
...
**Feature Suggestions:** 
Categorise workouts by muscle group
...
**Feature Suggestions:** 
    a) Dashboard listing main features 
    b) View PT workout sets
...
**Feature Suggestion:** 
CRUD customised workout routine
